...
| NPU-B. Graph matrix | Measure `FULLY_CONNECTED`, `SOFTMAX`, supported matrix operations, Burst and persistent-memory variants. | Reproducible decision based on latency, memory, thermal and failure data. |
