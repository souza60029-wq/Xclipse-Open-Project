...
| `Tudo sobre a xclipse/SAVE_retomada_caminho_RADV.pdf` | continuity PDF | Plans, commands, and conclusions requiring artifact cross-check. |
...
| `Tudo sobre a xclipse/caminho_RADV.zip` | probe/report package | Contains a probe explicitly described as not submitting GPU work. |
...
| `Tudo sobre a xclipse/logs para tentativa radv_xclipse.zip` | raw device/log package | Environment and diagnostic outputs; classify each command separately. |
