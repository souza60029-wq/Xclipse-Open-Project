...
**Status:** strong static evidence of shader/compiler/encoding infrastructure; no native XO940 ISA stream has been captured.
...
| `gfx10_4_GEN` and `MGFX*_GEN` | Do not prove that XO940 is GFX10.4 or that a specific backend is used at runtime. |
